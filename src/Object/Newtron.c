...
void Obj_Newtron(Object* obj) {
    ...
    case 0: // Initialization
        ...
        obj->mappings = Mappings_Newtron;
        obj->tile = TILE_MAP(0, 0, 0, 0, ArtTile_Newtron);
        obj->render.b = 0;
    ...
    case 2:
        ...
        case 0: // Check if near Sonic
        {
            ...
            if (scratch->subtype) {
                obj->tile = TILE_MAP(0, 1, 0, 0, ArtTile_Newtron);
                obj->routine_sec = 8;
                obj->anim = 4;
            }
            break;
        ...
        case 2: // Flying Newtron
        {
            ...
            if (floor_dist < 0) {
                ...
                obj->routine_sec += 2;
                obj->anim = 2;
                if (obj->tile & TILE_MAP(0, 1, 0, 0, ArtTile_Level)) // Condition never met
                    obj->anim++;
                obj->col_type = 0x0D;
                obj->xsp = 0x200;
        ...
        AnimateSprite(obj, Animation_Newtron);
        RememberState(obj);
        break;
    case 4: // Delete
        ObjectDelete(obj);
