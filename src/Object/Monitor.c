...
void Obj_Monitor(Object* obj)
{
    ...
    case 2: // Solid
        ...
        // Fallthrough
    case 6: // Animate
        AnimateSprite(obj, Animation_Monitor);
        // Fallthrough
    case 8: // Broken
        DisplaySprite(obj);
...
void Obj_MonitorItem(Object* obj)
{
    ...
    case 0: // Initialization
        ...
        const uint8_t* mapping_ind = (const uint8_t*)Mappings_Monitor + (obj->frame << 1);
        obj->mappings = Mappings_Monitor + ((mapping_ind[0] << 8) | (mapping_ind[1] << 0)) + 1;
        // Fallthrough
    case 2: // Move
        if (obj->ysp < 0) {
            // Move
